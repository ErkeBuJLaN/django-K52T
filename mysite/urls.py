...
urlpatterns = [
    ...
    path('aboutus', views.aboutus_view, name='aboutus_view'),
    ...
    path('service-4', views.service_4, name='service-4'),
    path('service-5', views.service_5, name='service-5'),
    path('service-6', views.service_6, name='service-6'),
]
